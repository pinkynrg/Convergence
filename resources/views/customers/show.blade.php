...
@section('content')
	...
	<div ajax-route="{{ route('ajax.customers.contacts',$customer->id) }}">
	...
	<div ajax-route="{{ route('ajax.customers.tickets',$customer->id) }}">
	...
	<div ajax-route="{{ route('ajax.customers.equipments',$customer->id) }}">
