...
var setupFilters = function () {
	...
	$("div[ajax-route]").each(function() {
		...
		if (typeof Cookies.get(cookie_name) != "undefined") {
			...
			filters = JSON.parse(Cookies.get(cookie_name));
...
$(".ajax_pagination").on('click','li',function (e) {
	var $target = $(this).closest("div[ajax-route]");
	e.preventDefault();
...
if (url.target == "escalation-profiles" && typeof url.target_id != "undefined") {
	...
	$("#escalation_events_table").on("click",".escalation_event_form i.delete_escalation_event", function () {
	...
	$("#escalation_events_table").on("click", "td.escalation_level", function () {
		consoleLog("expanded");
