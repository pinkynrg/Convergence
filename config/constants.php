...
define("TICKET_REQUESTING_STATUS_ID",8);
...
define("TICKET_IN_PROGRESS_ICON", "fa fa-ellipsis-h");
define("TICKET_WFF_ICON", "fa fa-hourglass-half");
define("TICKET_WFP_ICON", "fa fa-hourglass-half");
