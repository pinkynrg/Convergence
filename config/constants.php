...
define("FILES",PUBLIC_FOLDER.DS."files");	
define("DOCUMENTS",FILES.DS."documents");
define("ATTACHMENTS",FILES.DS."attachments");
define("THUMBNAILS",FILES.DS."thumbnails");
define("STYLE_IMAGES",FILES.DS."style");	
